...
class OfficeAccountParent(models.Model):
...
class OfficeAccount(models.Model):
        ...
        accountparent = models.ForeignKey(
            "OfficeAccountParent", on_delete=models.SET_NULL, null=True, blank=True)
...
class Employee(models.Model):
    employee = models.OneToOneField('Software_Settings.UserProfile',
...
class Loan(models.Model):
    ...
    payment_method = models.ForeignKey(
        OfficeAccount, on_delete=models.SET_NULL, related_name="loan_payment_method", blank=True, null=True)
    note = models.CharField(default="", max_length=255, blank=True, null=True)
    created = models.DateTimeField(default=timezone.now, editable=False)
    modified = models.DateTimeField(default=timezone.now)
...
class PaySlip(models.Model):
    ...
    payment_method_1 = models.ForeignKey(
        OfficeAccount, on_delete=models.SET_NULL, related_name="employee_payment_account1", null=True)
    ...
    payment_method_2 = models.ForeignKey(
        OfficeAccount, on_delete=models.SET_NULL, related_name="employee_payment_account2", null=True)
