...
from Software_Settings import models as contact_model
from Software_Settings import serializers as contact_serializer
from django.db.models import Q
from Software_Settings import permissions
...
class DesignationFilter(LoggingMixin, django_filters.FilterSet):
...
class DesignationViewSet(LoggingMixin, viewsets.ModelViewSet):
    authentication_classes = (TokenAuthentication, )
    # permission_classes = (permissions.CustomDjangoModelPermissions, )
...
class OfficeTypeViewSet(LoggingMixin, viewsets.ModelViewSet):
    authentication_classes = (TokenAuthentication, )
    # permission_classes = (permissions.CustomDjangoModelPermissions, )
...
class OfficeLocationViewSet(LoggingMixin, viewsets.ModelViewSet):
    authentication_classes = (TokenAuthentication, )
    # permission_classes = (permissions.CustomDjangoModelPermissions, )
...
class OfficeLocationUpdateView(LoggingMixin, viewsets.ModelViewSet):
...
class OfficeViewSet(LoggingMixin, viewsets.ModelViewSet):
    authentication_classes = (TokenAuthentication, )
    # permission_classes = (permissions.CustomDjangoModelPermissions, )
...
class OfficeAccountParentView(viewsets.ModelViewSet):
    """Handel creating and updating Attribute"""
    authentication_classes = (TokenAuthentication,)
    serializer_class = serializers.OfficeAccountParentSerializer
    queryset = models.OfficeAccountParent.objects.all().order_by('id')
    filter_backends = [DjangoFilterBackend]
    filterset_fields = ('name',)


class OfficeAccountView(viewsets.ModelViewSet):
    """Handel creating and updating Attribute"""
    authentication_classes = (TokenAuthentication,)
    serializer_class = serializers.OfficeAccountSerilizer
    queryset = models.OfficeAccount.objects.filter(is_active=True).order_by('id')
    filter_backends = [DjangoFilterBackend]
    filterset_fields = ('name',)
